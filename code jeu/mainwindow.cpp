...

{
    ...
    QFrame *Plack = new QFrame ;
    QFrame *card = new QFrame(window);

    card ->setFixedSize(275,200);

    card->setStyleSheet("background-image :url(C:/Users/Boba f kamate/Documents/free_your_hand/images/backbg.png)");
    Plack->setStyleSheet("background-image :url(C:/Users/Boba f kamate/Documents/free_your_hand/images/Plack.jpg)");
